...
public class RoomSpawner : MonoBehaviour
{
    ...
    */
    ...
    //Gets the arrays of room prefabs so it knows what prefabs should be used, then invoke the Spawn function within the 0.1 inteval.
    void Start() 
    {
    ...
    It checks the opening direction of the previous room and determines which array should be used to randomly choose a room.
    At the end sets the spawned variable to true to mke sure that another rooms does not spawn on top of it.
    */
    void Spawn()
    {
        if(spawned == false)
